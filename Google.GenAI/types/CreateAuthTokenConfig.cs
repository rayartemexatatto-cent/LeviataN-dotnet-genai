...
namespace Google.GenAI.Types {
  ...
  public record CreateAuthTokenConfig {
    ...
    /// will be rejected. (Gemini may preemptively close the session after this time.)  If not set
    /// then this defaults to 30 minutes in the future. If set, this value must be less than 20
    /// hours in the future.
    /// </summary>
    ...
    /// <summary>
    /// The time after which new Live API sessions using the token resulting from this request will
    /// be rejected.  If not set this defaults to 60 seconds in the future. If set, this value must
    /// be less than 20 hours in the future.
    /// </summary>
