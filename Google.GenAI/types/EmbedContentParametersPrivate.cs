...
namespace Google.GenAI.Types {
  ...
  internal record EmbedContentParametersPrivate {
    /// <summary>
    ...
    /// <returns>The deserialized EmbedContentParametersPrivate object, or null if deserialization
    /// fails.</returns>
